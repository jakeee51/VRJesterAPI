...
//
//public class CustomParticleType extends ParticleType<CustomParticleType.Data> {
...
//
//    public CustomParticleType(boolean alwaysShow) {
...
//        public final ParticleType<CustomParticleType.Data> particleType;
//
...
//
//        public Data(ParticleType<CustomParticleType.Data> particleType, int colour) {
//            this(particleType, 1, 1, colour);
//        }
//
//        public Data(ParticleType<CustomParticleType.Data> particleType, float scale, float ageModifier, int colour) {
//            this(particleType, scale, ageModifier, (colour >> 16) / 255.0f, ((colour >> 8) & 0xff) / 255.0f, (colour & 0xff) / 255.0f, (colour >> 24) / 255.0f);
//        }
//
//        public Data(ParticleType<CustomParticleType.Data> particleType, float scale, float ageModifier, float red, float green, float blue, float alpha) {
//            this.scale = scale;
