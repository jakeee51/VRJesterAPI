...
public class VoxNet {
    ...
    public void updateVoxNet(Vector3d center) {
...
//        int[] newId = new int[]{half_pos_x, half_pos_y, half_pos_z};
        int[] newId = new int[]{0, 0, 0};
        newId[0]++;
        createVox(center.add(VOX_LENGTH, (0), (0)), newId);
        newId[1]++;
        createVox(center.add((0), VOX_LENGTH, (0)), newId);
        newId[2]++;
        createVox(center.add((0), (0), VOX_LENGTH), newId);
        newId = new int[]{0, 0, 0};
        newId[0]--;
        createVox(center.subtract(VOX_LENGTH, (0), (0)), newId);
        newId[1]--;
        createVox(center.subtract((0), VOX_LENGTH, (0)), newId);
        newId[2]--;
        createVox(center.subtract((0), (0), VOX_LENGTH), newId);
//        for (int i = 1; i < VOX_TOTAL-1; i++) {
//            createVox(newCenter, newId);
//            half_pos_x++;
//            half_length += VOX_LENGTH;
//            newCenter = center.subtract(half_length, half_height, half_width);
//        }
    }
...
//    }
    ...
    public static boolean compareVector3d(Vector3d p1, Vector3d p2) {
