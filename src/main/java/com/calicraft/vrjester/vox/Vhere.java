...
public class Vhere {
    ...
    public Vhere(VRDevice vrDevice, Vector3d[] centroidPose, String configPath) {
    ...
    public Vector3d[] generateVhere(VRDataState vrDataRoomPre) {
    ...
    // Update Vhere center
    public void updateVherePosition(Vector3d dif) {
        centroid = dif;
    }
